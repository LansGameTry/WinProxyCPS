...
| File | Description |
|------|-------------|
| `WinProxy Loader.lua` | The loader file users execute (auto-updates) |
| `- WinProxy.lua_enc` | Encrypted script (fetched by the loader) |

---

Kalau draf ini sudah sesuai, **toggle ke Act mode** dan saya akan:
1. Simpan sebagai **`README.md`** di folder kamu (siap upload ke GitHub)
2. Kalau mau, saya buatkan juga **`Panduan Update.txt`** (cara update file enc ke GitHub) sebagai bonus

Mau saya simpan sebagai `README.md` langsung?
